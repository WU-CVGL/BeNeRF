...
class Model(nerf.Model):
    ...
    def build_network(self, args, poses=None, event_poses=None):
        ...
        self.graph.camera_crf = ColorToneMapper(hidden = 0, width = 128, input_type = "Gray")
        self.graph.event_crf = LuminanceToneMapper(hidden = 0, width = 128, input_type = "Gray")
        ...
        self.graph.camera_crf.weights_biases_init()
    ...
    def setup_optimizer(self, args):
        ...
        grad_vars_camera_crf = list(self.graph.camera_crf.parameters())
        self.optim_camera_crf = torch.optim.Adam(params = grad_vars_camera_crf, lr = 0.1)

        grad_vars_event_crf = list(self.graph.event_crf.parameters())
        self.optim_event_crf = torch.optim.Adam(params = grad_vars_event_crf, lr = 0.1)
